...
class Adapter_Responsive_Video_Widget extends \WP_Widget {
	...
	public function widget( $args, $instance ) {
		echo $args['before_widget'] . $this->get_markup( $instance ) . $args['after_widget']; // phpcs: ignore WordPress.Security.EscapeOutput.DeprecatedWhitelistCommentFound
	}
		...
		<div class="responsive-video-container" style="max-width:<?php echo esc_attr( strval( $max_width ) ); ?>px">
			<div class="embed-responsive <?php echo esc_attr( $aspect_ratio_class ); ?>">
				...
				if ( isset( $instance['iframe'] ) ) :
					echo $instance['iframe']; // phpcs: ignore WordPress.Security.EscapeOutput.DeprecatedWhitelistCommentFound
				else :
